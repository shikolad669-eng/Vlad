...
Музыка Влада как направление: что пишется/записывается, где выступает, что
релизится, как продвигается. Vault держит знание; сами файлы — в `../media/`
(вне git), здесь — карточки-указатели.
